...
const CompletedProjects = () => {
	const projects = [
		...
		},
		{
			sn: 2,
			project:
				"Barracuda Field Appraisal – Exploration Predrill Pore Pressure / Fracture Gradient Modeling & Safe Execution Analysis",
			location: "Niger Delta",
		...
		},
		{
			sn: 3,
			project:
				"Omerelu Field Appraisal – Exploration Predrill Pore Pressure / Fracture Gradient Modeling & Safe Execution Analysis",
			location: "Niger Delta",
			role: "Pore Pressure Prediction",
		...
		},
		{
			sn: 4,
			project:
				"Ruta Field Appraisal – Exploration Predrill Pore Pressure / Fracture Gradient Modeling & Safe Execution Analysis",
			location: "Niger Delta",
			role: "Pore Pressure Prediction",
		...
		},
		{
			sn: 12,
			project:
				"Regional evaluation and portfolio analysis of Eastern Niger Delta Shallow offshore",
			location: "Niger Delta, Nigeria",
		...
		},
		{
			sn: 14,
			project:
				"Regional evaluation and portfolio analysis of Eastern Niger Delta Shallow offshore and Western Swamp",
			location: "Niger Delta, Nigeria",
