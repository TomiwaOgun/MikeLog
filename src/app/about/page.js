  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-8xl mx-auto bg-white rounded-lg shadow-lg p-8">
        {/* Page Title */}
        <h1 className="text-6xl font-bold text-center mb-15">About Us</h1>
        ...
        {/* Profile Picture */}
        <div className="flex justify-center p-20 mb-12">
        ...
        {/* Principle */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold mb-4">Our Principle</h2>
